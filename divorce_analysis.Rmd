...
```{r clusters}
clusters.vars.A <- c("year", "sexeduc", "region", "premarsx", "xmarsex", "partyid", "fund", "childs",  "degree", "Agecat1", "widowed", "educ", "wrkstat", "polviews", "happy", "trust", "class",  "reg16", "family16", "born", "parborn", "income", "size", "attend", "relig16", "bible", "satfin", "abnomore", "absingle", "divlaw", "fefam", "marital2")
...
#using packages factoextra and NbClust
library(factoextra)
library(NbClust)

#determine optimal number of clusters using method within-cluster sum of squares
fviz_nbclust(clusters.train.a, kmeans, method = "wss") 
sil.a <- silhouette(,)
