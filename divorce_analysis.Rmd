...
```{r clusters}
clusters.vars.A <- c("year", "sexeduc", "region", "premarsx", "xmarsex", "partyid", "fund", "childs",  "degree", "Agecat1", "widowed", "educ", "wrkstat", "polviews", "happy", "trust", "class",    "reg16", "family16", "born", "parborn", "income91", "size", "attend", "relig16", "bible", "satfin", "abnomore", "absingle", "divlaw", "fefam", "marital2")
