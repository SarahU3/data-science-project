...
# accuracy
# slightly better predictor for split
...
# accuracy
# not any better predictor for split
...
For both decision trees and random forests (below) we tested using both the complete cases and imputing data to fill in missing values. 

### Decision Tress with Complete Cases
...
### Decision Trees with Imputed Values
...
```
### Decision Trees: Comparing Results
```{r test models on complete data, include=FALSE, cache=TRUE}
#Ballot A
...
However, none of kmeans, pam, and hierarchical clustering methods correctly categorizes by married and split. 
...
kmeans    | predicted marriage | predicted split
----------|--------------------|----------------
married   | 940                | 1453
split     | 380                | 599
